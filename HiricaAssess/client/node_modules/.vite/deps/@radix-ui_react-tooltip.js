...
import {
  useSize
} from "./chunk-PSBGE6GQ.js";
import {
  Root
} from "./chunk-AJPVFUNI.js";
import {
  useId
} from "./chunk-HAJJ3CHK.js";
import {
  DismissableLayer,
  Portal
} from "./chunk-PENKLQDS.js";
import {
  Presence,
  composeEventHandlers,
  useControllableState
} from "./chunk-JMFBHX5G.js";
import {
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-WUARESHO.js";
import {
  composeRefs,
  useComposedRefs
} from "./chunk-N6Z6HD6D.js";
import {
  require_react_dom
} from "./chunk-RXMVD6D7.js";
import {
  require_jsx_runtime
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React12.useRef(true);
  const isPointerInTransitRef = React12.useRef(false);
  ...
  return (0, import_jsx_runtime11.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React12.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React12.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React12.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React12.useRef(false);
  ...
  const stateAttribute = React12.useMemo(() => {
  ...
  return (0, import_jsx_runtime11.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime11.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React12.useCallback(() => {
...
var TooltipTrigger = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const handlePointerUp = React12.useCallback(() => isPointerDownRef.current = false, []);
    React12.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(PortalProvider, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime11.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME;
var CONTENT_NAME2 = "TooltipContent";
var TooltipContent = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime11.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime11.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React12.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React12.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React12.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React12.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React12.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime11.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable4 = createSlottable3("TooltipContent");
var TooltipContentImpl = React12.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime11.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime11.jsx)(Slottable4, { children }),
              (0, import_jsx_runtime11.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime11.jsx)(Root, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime11.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
