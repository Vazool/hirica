      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">Student Sign Up</h2>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Join thousands of graduates finding their dream jobs</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-muted-foreground">
                ...
                <Link href="/student/signin" className="text-primary hover:underline" data-testid="link-signin">
                  Sign in
                </Link>
              </p>
            </div>
